...
6.2 Lecture fichier
6.2.1 Résultat d'après le fichier par défaut//image
6.3 Aleatoire
6.3.1 Totalement Aléatoire
6.3.1.1 Résultat pour une taille aléatoire//image
6.3.1.2 Résultat pour une taille imposée//image
6.3.1.3 Résultat enregistré dans un fichier//image
6.3.2 Pseudo Aléatoire
6.3.2.1 Résultats pour une taille alétoire//image
6.3.2.2 Résultats pour une taille imposée//image
6.3.2.3 Résultats enregistré dans un fichier//image
6.3.3 Avec Piles
6.3.3.1 Résultat pour une taille aléoatoire//image
6.3.3.2 Résultats pour une taille imposée//image
6.3.3.3 Résultats enregistré dans un fichier//image
